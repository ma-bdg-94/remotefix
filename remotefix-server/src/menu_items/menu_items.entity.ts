...
export class MenuItem extends BaseEntity {
  private static readonly ALLOWED_SCOPES = ['navigation', 'sub_navigation'];
  ...
  @IsBoolean({
    message: "Can accept only logic (boolean) values for menu item's privacy!",
  })
  is_private: boolean;
