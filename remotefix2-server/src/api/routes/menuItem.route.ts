...
import {
  ...
  validateMenuItemId,
  validateMenuItemScope,
  validateMenuItemUpdate,
  validateSortingCriteria,
} from "../middlewares/validations/menuItem.validation";
const {
  createMenuItem,
  addSubItem,
  getAllMenuItems,
...
router.post("/sub/:itemId/:subItemId", validateMenuItemId, addSubItem);

router.get("/all", validateSortingCriteria, getAllMenuItems);
router.get(
  "/all/public/scope",
  [validateSortingCriteria, validateMenuItemScope],
  getAllMenuItemsByScope
);
...
router.put(
  "/:id",
  [validateMenuItemId, validateMenuItemUpdate],
  updateMenuItem
);
...
router.patch(
  "/scope/:id",
  [validateMenuItemId, validateMenuItemScope],
  updateMenuItemScope
);
...
router.delete("/sub/:itemId/:subItemId", removeSubItem);
